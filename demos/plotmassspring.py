...
for endtime in explicit_euler_larger_endtimes:
    ...
    plt.xlabel('time')
    plt.ylabel('value')
    plt.title(f"explicit_euler: Mass-Spring System Time Evolution for 100 timesteps.")
    plt.legend()
    plt.grid()
    ...
    plt.xlabel('position')
    plt.ylabel('velocity')
    plt.title(f"explicit_euler: Mass-Spring System Phase Plot for 100 timessteps.")
    plt.legend()
    plt.grid()
